 ...
 * @returns 학과 정보
 */
export const getDepartmentInfo = async (college: College, department: Department) => {
 ...
 * @returns 학과 일정 목록
 */
export const getDepartmentSchedules = async (college: College, department: Department) => {
